...
namespace FreelanceHunt.Controls
{
    ...
    public class LayoutAwarePageBase : Page
    {
        ...
        /// <summary>
        /// Стандартный словарь стилей и шаблонов
        /// </summary>
        public ResourceDictionary CustomResources = new ResourceDictionary()
        {
            Source = new Uri("ms-appx:///Styles/StandardStyles.xaml", UriKind.Absolute)
        };
        /// <summary>
        ...
        private void WindowSizeChanged(object sender, WindowSizeChangedEventArgs e)
        {
            ...
            this.InvalidateVisualState(state);
#endif
        }
        ...
        /// changed.
        /// </remarks>
        public void InvalidateVisualState(ApplicationViewState state)
        {
            if (this._layoutAwareControls != null)
            {
                string visualState = DetermineVisualState(state);
