    ...
    public sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // навигации
                var settings = ViewModels.ViewModelLocator.Configuration;
                var typeOfStartPage = string.IsNullOrEmpty(settings.Secret) || string.IsNullOrEmpty(settings.Token) ? typeof(LoginPage) : typeof(MainPage);
                if (!rootFrame.Navigate(typeOfStartPage, e.Arguments))
                {
